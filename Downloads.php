...
<body>
  ...
  <div class="container2">
    ...
    $fetct_query = "SELECT * FROM `downloads`"; 
    ...
    while($row = mysqli_fetch_assoc($result)){
      ...
      <button><a href="admin/includes/images/download/'. $row["file_name"]    .'" target="_blank" rel="noopener noreferrer">View</a></button>
    </div>';
...
?>
    ...
    <!-- <div class="item1">
      ...
      <!-- <button>Download</button> -->
      <!-- <button><a href="./files/service charges.pdf" target="_blank" rel="noopener noreferrer">View</a></button>
    </div> -->
    ...
    <!-- <div class="item1">
      ...
      <button><a href="./files/DICGC.pdf" target="_blank" rel="noopener noreferrer">View</a></button>
    </div>
    <div class="item1">
      <svg fill="#000000" width="800px" height="800px" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
        <g fill-rule="evenodd">
      ...
      <button><a href="./files/Annual report.pdf" target="_blank" rel="noopener noreferrer">View</a></button>
    </div>
    <div class="item1">
      <svg fill="#000000" width="800px" height="800px" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
        <g fill-rule="evenodd">
      ...
      <button><a href="./files/General Body Book 2023.pdf" target="_blank" rel="noopener noreferrer">View</a></button>
    </div>
    <div class="item1">
      <svg fill="#000000" width="800px" height="800px" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
        <g fill-rule="evenodd">
      ...
      <div class="filename">
        <p>Customer Service Request Form</p>
        <div class="filedata">
          <span>1 File</span>
          <span>●</span>
          <span>908 KB</span>
      ...
      <button><a href="./files/Customer Service Request Form.pdf" target="_blank"
          rel="noopener noreferrer">View</a></button>
    </div> -->
